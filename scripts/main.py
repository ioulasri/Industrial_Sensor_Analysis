...
def plot_sensor_trends(df, unit_id, sensors=[2, 3, 4], save_path=None):
...
def plot_sensor_distribution(df, sensor=2, save_path=None):
...
def plot_boxplot(df, sensor=2, save_path=None):
    """Plots a boxplot for a specific sensor to identify outliers."""
...
def plot_rolling_average(df, unit_id, sensor=2, window=5, save_path=None):
    """Plots the rolling average for a specific sensor to smooth trends."""
    df_unit = df[df['unit_number'] == unit_id]
...
# Visualizations
plot_sensor_trends(df, unit_id=1, save_path="../visualizations/sensor_trends.png")
plot_correlation_heatmap(df, save_path="../visualizations/correlation_heatmap.png")
plot_sensor_distribution(df, sensor=2, save_path="../visualizations/sensor_distribution.png")
plot_boxplot(df, sensor=2, save_path="../visualizations/sensor_boxplot.png")
plot_rolling_average(df, unit_id=1, sensor=2, window=10, save_path="../visualizations/rolling_avg.png")